...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TraccarClientSDK",
            url: "https://github.com/traccar/traccar-client-sdk/releases/download/v1.0.6/TraccarClientSDK.xcframework.zip", checksum: "e417b82c21d835ec7415ad18607141a7f34902a7243c6488183c2be66202c89a"
        ),
        .target(
