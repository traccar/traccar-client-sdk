...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TraccarClientSDK",
            url: "https://github.com/traccar/traccar-client-sdk/releases/download/v0.0.5/TraccarClientSDK.xcframework.zip", checksum: "214d4cccc0869495328a2eab1e8bd740cc7307fa1f58e06d4c58d478ebd7f3d1"
        ),
        .target(
