...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TraccarClientSDK",
            url: "https://github.com/traccar/traccar-client-sdk/releases/download/v0.0.21/TraccarClientSDK.xcframework.zip", checksum: "e0810e577a0ee2f8577313825851107e7336051cfebc238fd22e0fadf1a1f9db"
        ),
        .target(
