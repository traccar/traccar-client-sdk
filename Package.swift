...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TraccarClientSDK",
            url: "https://github.com/traccar/traccar-client-sdk/releases/download/v0.0.9/TraccarClientSDK.xcframework.zip", checksum: "4cf1bc1c885882e8b39e1bb031a38e484578c9f7af752a951bcf792d148aedea"
        ),
        .target(
