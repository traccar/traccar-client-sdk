...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TraccarClientSDK",
            url: "https://github.com/traccar/traccar-client-sdk/releases/download/v0.0.22/TraccarClientSDK.xcframework.zip", checksum: "9b01a9a84d6421275ae6da1e42e3d5e9f18ab5bde3068726cbd770a4188cfb3d"
        ),
        .target(
