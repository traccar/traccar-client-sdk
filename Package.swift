...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TraccarClientSDK",
            url: "https://github.com/traccar/traccar-client-sdk/releases/download/v0.0.6/TraccarClientSDK.xcframework.zip", checksum: "a9df175a95bb474e310c548bded3be23af6c1442d92d7fbe406cf01a17055fed"
        ),
        .target(
